...
server.listen(8080, function () {
  console.log(new Date().Format("yyyy-MM-dd hh:mm:ss") + ' Server is listening on port 8080');
});
...
function readDb() {
  ...
  connection.query('delete from `atkinfo2` where `atkTime` < ? ;', [limitSeconds], function(){});
